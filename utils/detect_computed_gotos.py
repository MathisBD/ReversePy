...
# Just run the file with your favorite python interpreter to get the answer.
# To compile python without computed gotos, pass --without-computed-gotos to the configure script.
import sys
